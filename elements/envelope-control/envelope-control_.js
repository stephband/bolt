...
import { clamp, by, insert, get, noop, overload, toCamelCase, toLevel, id, notify, nothing, observe, remove } from '../../fn/module.js';
import * as normalise from '../../fn/modules/normalisers.js';
import * as denormalise from '../../fn/modules/denormalisers.js';
import { rect as box, gestures } from '../../dom/module.js';
...
//register('envelope-control',
function(svg, scopes, params) {
